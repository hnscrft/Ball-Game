...
public class FollowPlayer : MonoBehaviour
{
    ...
    void Start()
    {
        playerPosition = chosenObject.transform.position; //sets playerPosition's value to the transform.position of the player
    ...
    void Update()
    {
        playerPosition = chosenObject.transform.position; //updates playerPosition
